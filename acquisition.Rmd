...
partition_time3696969600 = read.csv("E:/hackathon-encoded/profile/partition_time=3696969600/1.csv",header = F)
partition_time3699475200 = read.csv("E:/hackathon-encoded/profile/partition_time=3699475200/2.csv",header = F)
partition_time3702153600 = read.csv("E:/hackathon-encoded/profile/partition_time=3702153600/3.csv",header = F)
partition_time3704745600 = read.csv("E:/hackathon-encoded/profile/partition_time=3704745600/4.csv",header = F)
partition_time3707424000 = read.csv("E:/hackathon-encoded/profile/partition_time=3707424000/5.csv",header = F)
partition_time3710016000 = read.csv("E:/hackathon-encoded/profile/partition_time=3710016000/6.csv",header = F)
partition_time3712694400 = read.csv("E:/hackathon-encoded/profile/partition_time=3712694400/7.csv",header = F)
partition_time3715372800 = read.csv("E:/hackathon-encoded/profile/partition_time=3715372800/8.csv",header = F)
partition_time3717964800 = read.csv("E:/hackathon-encoded/profile/partition_time=3717964800/9.csv",header = F)
partition_time3720643200 = read.csv("E:/hackathon-encoded/profile/partition_time=3720643200/10.csv",header = F)
partition_time3723235200 = read.csv("E:/hackathon-encoded/profile/partition_time=3723235200/11.csv",header = F)
partition_time3725913600 = read.csv("E:/hackathon-encoded/profile/partition_time=3725913600/12.csv",header = F)
partition_time3728592000 = read.csv("E:/hackathon-encoded/profile/partition_time=3728592000/13.csv",header = F)
